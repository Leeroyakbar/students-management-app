...
<html
  ...
  data-assets-path="{{ asset('app_assets/assets/') }}"
...
>
  <head>
    ...
    <title>Dashboard - Neuron Task</title>
    ...
    <link rel="stylesheet" href="{{ asset('app_assets/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
                <img src="{{ asset('neuron-logo.png') }}" alt="" style="width: 50px; height: auto;">
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Neuron</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href="{{ route('dashboard') }}" class="menu-link ">
                  ...
                  <div data-i18n="Analytics">Tracker</div>
                </a>
              </li>
        </aside>
        <!-- / Menu -->
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('app_assets/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('app_assets/assets/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('app_assets/assets/js/dashboards-analytics.js') }}"></script>
