        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Neuron Task! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start recording your tasks</p>

              <form id="formAuthentication" class="mb-3" action="{{ route('login.action') }}" method="POST" class="user">
                @csrf
                @if ($errors->any())
